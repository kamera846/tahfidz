                  ...
                  <tr>
                    ...
                    <td class="text-center">
                      <div class="d-flex align-items-center row">
                        <span class="col-md-2">{{ $s->murojaah->halaman }}/20</span>
                        <div class="col-md-9">
                          <div class="progress">
                            @if( $s->murojaah->halaman <= 2 )
