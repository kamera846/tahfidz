      ...
      <div class="row justify-content-md-center">
        <div class="col col-xl-6">
          <div class="card p-3">
            ...
            <div class="card-body">
              <form class="form-horizontal" action="/manage/wali/update/<?php echo e($data->id); ?>" method="post">
                ...
                <!-- <div class="form-group mb-2">
                    <div class="input-group input-group-merge input-group-alternative mb-3">
                        ...
                        <input class="form-control" placeholder="Email" id="email" type="email" name="email" value="<?php echo e($data->email); ?>" required autofocus>
                    </div>
                ...
                <div class="form-group mb-2">
                  <div class="input-group input-group-merge input-group-alternative">
                    ...
                    <input placeholder="Nama Wali Santri" id="name" type="text" class="form-control" name="name" value="<?php echo e($data->nama); ?>" required>
                  </div>
                </div>
                    ...
                    <div class="form-group mb-2">
                        <div class="input-group input-group-merge input-group-alternative">
                            ...
                            <input placeholder="Nomer Telp" id="no_telp" type="number" class="form-control" name="no_telp" value="<?php echo e($data->no_telp); ?>" required>
                        </div>
                    </div>
                    <div class="form-group mb-2">
                        <div class="input-group input-group-merge input-group-alternative">
                ...
                <div class="form-group mb-2">
                  <div class="input-group input-group-merge input-group-alternative">
                    ...
                    <input placeholder="Alamat" id="alamat" type="text" class="form-control" name="alamat" value="<?php echo e($data->alamat); ?>" required>
                  </div>
                </div>
