                  ...
                  <tr>
                    ...
                    <td class="text-center">
                      <div class="d-flex align-items-center row">
                        <span class="col-md-2"><?php echo e($s->murojaah->where('jenis', 'wajib')->first()->halaman); ?>/20</span>
                        <div class="col-md-9">
                          <div class="progress">
                            <?php if( $s->murojaah->where('jenis', 'wajib')->first()->halaman <= 2 ): ?>
                            ...
                            <?php elseif( $s->murojaah->where('jenis', 'wajib')->first()->halaman <= 4 ): ?>
                            ...
                            <?php elseif( $s->murojaah->where('jenis', 'wajib')->first()->halaman <= 6 ): ?>
                            ...
                            <?php elseif( $s->murojaah->where('jenis', 'wajib')->first()->halaman <= 8 ): ?>
                            ...
                            <?php elseif( $s->murojaah->where('jenis', 'wajib')->first()->halaman <= 10 ): ?>
                            ...
                            <?php elseif( $s->murojaah->where('jenis', 'wajib')->first()->halaman <= 12 ): ?>
                            ...
                            <?php elseif( $s->murojaah->where('jenis', 'wajib')->first()->halaman <= 14 ): ?>
                            ...
                            <?php elseif( $s->murojaah->where('jenis', 'wajib')->first()->halaman <= 16 ): ?>
                            ...
                            <?php elseif( $s->murojaah->where('jenis', 'wajib')->first()->halaman <= 18 ): ?>
                            ...
                            <?php elseif( $s->murojaah->where('jenis', 'wajib')->first()->halaman <= 20 ): ?>
